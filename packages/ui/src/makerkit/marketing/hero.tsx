...
export function Hero({
  ...
  return (
    <div className={cn('w-full flex flex-col space-y-20', className)}>
      <div
        style={{
          MozAnimationDuration: '100ms',
        }}
        className={cn(
          'w-full flex flex-1 flex-col items-center justify-center duration-800 md:flex-row',
          {
      ...
      >
        <div className="flex w-full flex-1 flex-col items-center gap-y-6 xl:gap-y-8 2xl:gap-y-12">
          {pill && (
            <div
              className={cn({
                ['animate-in fade-in delay-300 duration-700']:
                  animate,
              })}
            >
              {pill}
      ...
      {image && (
        <div
          ...
          className={cn('w-full mx-auto flex justify-center py-8', {
