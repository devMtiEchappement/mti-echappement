...
const FeatureFlagsSchema = z.object({
  ...
  enableLanguageSelector: z.boolean({
    description: 'Enable language selector in the user interface.',
    required_error: 'Provide the variable NEXT_PUBLIC_ENABLE_LANGUAGE_SELECTOR',
  }),
...
const featuresFlagConfig = FeatureFlagsSchema.parse({
  ...
  enableLanguageSelector: getBoolean(
    process.env.NEXT_PUBLIC_ENABLE_LANGUAGE_SELECTOR,
    true,
  ),
